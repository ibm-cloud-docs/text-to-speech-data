...
For more information about using SSML to annotate input text, see [Using SSML](/docs/text-to-speech-data?topic=text-to-speech-data-ssml). For an inventory of all supported elements and attributes, see [SSML elements](/docs/text-to-speech-data?topic=text-to-speech-data-elements).
