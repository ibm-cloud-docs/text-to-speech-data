...
For more information about working with SPR, see [Using IBM SPR](/docs/services/text-to-speech-data?topic=text-to-speech-data-sprs).
...
The following table lists the parts of speech that are supported for Japanese custom entries. For more information about specifying the part of speech for a Japanese custom entry, see [Adding words to a Japanese custom model](/docs/services/text-to-speech-data?topic=text-to-speech-data-customWords#cuJapaneseAdd).
