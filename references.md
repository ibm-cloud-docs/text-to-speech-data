...
For more detailed information about the research and technical background behind {{site.data.keyword.texttospeechdatafull}} for {{site.data.keyword.icp4dfull}}, see the following documents.
{: shortdesc}
