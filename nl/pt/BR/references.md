...
Para obter mais informações sobre a pesquisa por trás do {{site.data.keyword.texttospeechdatafull}} para o {{site.data.keyword.icp4dfull}}, consulte os documentos a seguir. Os pesquisadores da IBM escreveram ou contribuíram com todos esses artigos.
{: shortdesc}
