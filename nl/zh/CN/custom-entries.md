...
如[查询定制模型](/docs/services/text-to-speech-data?topic=text-to-speech-data-customModels#cuModelsQuery)中所述，您还可以使用 `GET /v1/customizations/{customization_id}` 方法来查看定制模型的元数据和词：
