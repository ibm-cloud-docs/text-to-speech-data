...
如[查詢自訂模型](/docs/services/text-to-speech-data?topic=text-to-speech-data-customModels#cuModelsQuery)中所述，您也可以使用 `GET /v1/customizations/{customization_id}` 方法來查看自訂模型的 meta 資料及字組：
