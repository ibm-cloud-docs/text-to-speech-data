...
Para obtener más información sobre la investigación detrás de {{site.data.keyword.texttospeechdatafull}} for {{site.data.keyword.icp4dfull}}, consulte los siguientes documentos. Los investigadores de IBM han escrito o contribuido en todos estos documentos.
{: shortdesc}
