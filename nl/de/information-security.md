...
In {{site.data.keyword.texttospeechdatafull}} for {{site.data.keyword.icp4dfull}} können Sie alle Daten löschen, die mit Sprachsyntheseanforderungen und angepassten Sprechmodellen verbunden sind. Zum Löschen der Daten müssen Sie Folgendes ausführen:
