...
[사용자 정의 모델 조회](/docs/services/text-to-speech-data?topic=text-to-speech-data-customModels#cuModelsQuery)에 설명된 대로 `GET /v1/customizations/{customization_id}` 메소드를 사용하여 사용자 정의 모델에 대한 메타데이터와 단어를 모두 볼 수도 있습니다.
