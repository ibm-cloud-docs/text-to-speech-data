...
`es-LA_SofiaV3Voice` 및 `es-US_SofiaV3Voice` 음성은 필수적으로 동일한 음성입니다. 가장 중요한 차이점은 두 가지 음성이 $(달러 부호)를 해석하는 방식에 관한 것입니다. 라틴 아메리카 버전은 *pesos* 용어를 사용하고 북아메리카 버전은 *d&oacute;lares* 용어를 사용합니다. 두 음성 간의 기타 사소한 차이점도 존재할 수 있습니다.
{: note}
