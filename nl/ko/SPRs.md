...
{{site.data.keyword.texttospeechdatafull}} for {{site.data.keyword.icp4dfull}}는 단어의 소리를 나타내도록 표준 IPA(International Phonetic Alphabet) 및 {{site.data.keyword.IBM}} Symbolic Phonetic Representation(SPR) 표기법을 모두 지원합니다. SPR은 단어의 발음, 단어를 구성하는 소리, 소리가 음절로 구분되는 방식 및 강조되는 음절을 나타내는 음성 코딩입니다. SPR은 IPA의 대체 표시입니다.
{: shortdesc}
...
SPR 발음은 SSML(SSpeech Synthesis Markup Language )의 [음소 요소](/docs/services/text-to-speech-data?topic=text-to-speech-data-elements#phoneme_element)로 정의됩니다. 이는 큰따옴표로 묶은 지정된 언어에 적합한 일련의 허용 가능한 기호로 구성됩니다. 기호는 `<phoneme>` 요소 내의 단어가 발음되는 방식을 정의합니다. 요소의 `alphabet` 속성에는 발음이 SPR에 정의되고 `ph` 속성이 발음을 정의함을 나타내는 `ibm` 값이 있습니다. 다음은 미국 영어의 *through* 및 *shocking* 단어에 대한 올바른 SPR 표기법의 예입니다.
...
-   IPA 유니코드 값으로 IPA 발음을 지정할 수도 있습니다. 다음 절에 나열된 언어별 표에는 IPA 기호 및 동등한 IPA 유니코드 값이 문서화되어 있습니다. IPA 유니코드 값을 사용하는 발음의 예는 [발음 요소](/docs/services/text-to-speech-data?topic=text-to-speech-data-elements#phoneme_element)를 참조하십시오.
...
-   [브라질 포르투갈어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-ptSymbols)
-   [영국 영어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-gbSymbols)
-   [프랑스어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-frSymbols)
-   [독일어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-deSymbols)
-   [이탈리아어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-itSymbols)
-   [일본어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-jaSymbols)
-   [스페인어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-esSymbols)
-   [미국 영어 기호](/docs/services/text-to-speech-data?topic=text-to-speech-data-usSymbols)
