...
-   For more information about specifying SPR translations and their equivalent IPA symbols, see [Using IBM SPR](/docs/text-to-speech-data?topic=text-to-speech-data-sprs).
